...
export const App = () => {
  ...
  return (
    <div className={'w-full min-h-screen grid overflow-x-hidden bg-gradient-to-r from-cyan-500 to-sky-500 dark:from-indigo-500 dark:to-purple-500 text-[#f8f8f2]'}>
      <div className={'w-full h-full flex flex-col items-center justify-center gap-4 px-6 py-8'}>
        <h1 className={'font-medium text-center uppercase tracking-widest'}>Stored Theme Hooks</h1>
